...
public class Cuadrado {
    ...
    static float squadCoords[] = { //Arreglo (matris) de las coordenadas de un triangulo
            //X, Y, Z
    ...
    private final int vertexCount = squadCoords.length / COORDS_PER_VERTEX; //contador de vertices
